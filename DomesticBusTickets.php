...
<html>
	<head>
		<title>Domestic Bus Tickets</title>
	...
	<body>
		...
		<div id="container" style="height:130%;"><br>
			<h1 class="central_textalign">Domestic Bus Tickets</h1>
			<div style=margin:1% 1% 1% 1%;>
				<form name="Domestic Bus Tickets" id="f1">
					...
					<p style="margin-left:4.25%;"> Passenger 1 :<br>
									...
									&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Gender : <input class="bre15px" type="Radio" value="Female" name="pass1_gender"><span style="font-weight:normal;">Female &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
					...
					<p style="margin-left:4.25%;">Passenger 2 :<br>
									...
									&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Gender : <input class="bre15px" type="Radio" value="Female" name="pass2_gender"><span style="font-weight:normal;">Female &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
					...
					<p style="margin-left:4.25%;">Passenger 3 :<br>
									...
									&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Gender : <input class="bre15px" type="Radio" value="Female" name="pass3_gender"><span style="font-weight:normal;">Female &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
					...
					<p style="margin-left:4.25%;">Passenger 4 :<br>
									...
									&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Gender : <input class="bre15px" type="Radio" value="Female" name="pass4_gender"><span style="font-weight:normal;">Female &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
					...
					<p style="margin-left:4.25%;">Passenger 5 :<br>
									...
									&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Gender : <input class="bre15px" type="Radio" value="Female" name="pass5_gender"><span style="font-weight:normal;">Female &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
