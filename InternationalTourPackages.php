...
<html>
	...
	<body>
		...
		<div id="container" style="height:178%;"><br>
			<h1 class="central_textalign">International Tour Packages</h1>
			<div style=margin:1% 1% 1% 1%;>
				<form name="International Tour Packages" id="f1">
					<table style="margin-left:3%;">		
						<tr>
							...
							<td><input style="margin-left:3%;" type="text" name="cus_mail"></td>
						</tr>
						<tr>
					...
					<p style="margin-left:3%;">Passenger 1 :<br>
									...
									&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Gender : <input class="bre15px" type="Radio" value="Female" name="pass1_gender"><span style="font-weight:normal;">Female &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
					...
					<p style="margin-left:3%;">Passenger 2 :<br>
									...
									&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Gender : <input class="bre15px" type="Radio" value="Female" name="pass2_gender"><span style="font-weight:normal;">Female &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
					...
					<p style="margin-left:3%;">Passenger 3 :<br>
									...
									&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Gender : <input class="bre15px" type="Radio" value="Female" name="pass3_gender"><span style="font-weight:normal;">Female &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
					...
					<p style="margin-left:3%;">Passenger 4 :<br>
									...
									&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Gender : <input class="bre15px" type="Radio" value="Female" name="pass4_gender"><span style="font-weight:normal;">Female &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
					...
					<p style="margin-left:3%;">Passenger 5 :<br>
									...
									&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Gender : <input class="bre15px" type="Radio" value="Female" name="pass5_gender"><span style="font-weight:normal;">Female &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
