...
<html>
	<head>
		<title>Domestic Air tickets</title>
	...
	<body>
		...
		<div id="container" style="height:177%;"><br>
			<h1 class="central_textalign">Domestic Air Tickets</h1>
			<div style=margin:1% 1% 1% 1%;>
				<form name="Domestic Air Tickets" id="f1">
					...
					<p style="margin-left:5%;">Tickets : 
						<input style="margin-left:1.5%;" class="bre15px" type="Radio" value="Refundable" name="refund">&nbsp <span style="font-weight:normal;"> Refundable(higher-cost) &nbsp&nbsp&nbsp
						<input class="bre15px" type="Radio" value="Non - Refundable" name="refund">&nbsp Non - Refundable (lower-cost) </span>	
							&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Class: 
							<input style="margin-left:2%;" class="bre15px" type="Radio" value="First" name="type"><span style="font-weight:normal;">&nbsp First &nbsp&nbsp&nbsp&nbsp
					...
					<p style="margin-left:5%;">Preferred Airlines : <span style="margin-left:1%;"> 1. <input class="pref" type="text" name="air1"></span>
					...
					<p style="margin-left:4.5%;">Preferred Airport : <span style="margin-left:1.6%;">1. <input class="pref" type="text" name="airp1"></span>
					...
					<p style="margin-left:5%;">Weight Of baggage during departure (in Kgs) : <input class="pref" type="number" name="wei_bag"></p><br><br>
